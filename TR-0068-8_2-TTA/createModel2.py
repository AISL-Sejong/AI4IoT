...
filenames = os.listdir(full_path)   #"/train")
categories = []
...
image = load_img(full_path + '/' +sample)  #"./train/"+sample)
plt.imshow(image)
...
MODEL_DIR = absolute_path + '/model' #./model/'
if not os.path.exists(MODEL_DIR):
    os.mkdir(MODEL_DIR)
    
modelpath = absolute_path + '/model/{epoch:02d} - {val_loss:.4f}.hdf5' #'./model/ {epoch:02d} - {val_loss:.4f}.hdf5'
