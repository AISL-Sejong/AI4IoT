...
HOST = '172.16.6.177' #'192.168.247.1' #socket(client) 통신, HOST IP는 사용 PC에 따라 달라질 수 있음.
PORT =  3105
...
while True:
    ...
    #save decoded trData resource to image file (trData.jpg) ; CWD/augmetData 존재해야 함
    #CHECK ./augmetData/RN-augT-augP/에 저장 augmented images 저장
    ...
    #directory = 'augmetData//' + jsonObj['rn'] + '-' + augType
    ...
    # CHECK 상위 폴더로 위치 변경
    #BASE_PATH = "Augmented/Output"
    #os.path.sep.join(["augmented", "abc"])
